function forecast(arr) {
  ...
  /**
   * slice() takes only 2 parameters — the first is the index at which
   *  to begin extraction, and the second is the index at which to
   *  stop extraction (extraction will occur up to, but not including 
