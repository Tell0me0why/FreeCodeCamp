...
console.log(result)
/**
 * Searching is useful. However, you can make searching
 *  even more powerful when it also changes (or replaces)
 *  the text you match.

You can search and replace text in a string using .replace()
 on a string. The inputs for .replace() is first the regex 
 pattern you want to search for. The second parameter is 
...
You can also access capture groups in the replacement 
