...
let myRegex = /Hello/;
let result = myRegex.test(myString); // Change this li
console.log(result);
/*
If you want to find the word the in the string The dog chased
 the cat, you could use the following regular expression: /the/.
