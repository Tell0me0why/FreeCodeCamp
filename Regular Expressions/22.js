...
let userCheck = /^[a-z][a-z][a-z]*\d*$|^[a-z][a-z]$|^[a-z]\d\d+$/i; // Change this line
let result = userCheck.test(username);

/*
Usernames are used everywhere on the internet. They are what give users a unique identity on
